...
<div class="d-flex flex-column p-3 text-white bg-primary" style="width: 280px; height: 100vh;">
   ...
   <ul class="nav flex-column">
        ...
        <li>
            <a data-page="niveles"
            href="http://localhost:3000/module/niveles.html"
            class="nav-link text-white">
        ...
        <li>
            <a data-page="inscripciones"
            href="http://localhost:3000/module/inscripciones.html"
            class="nav-link text-white">
            <i class="fas fa-user-check me-2"></i>Inscripciones
            </a>
        </li>

        <li>
            <a data-page="asistencias"
            href="http://localhost:3000/module/asistencias.html"
            class="nav-link text-white">
